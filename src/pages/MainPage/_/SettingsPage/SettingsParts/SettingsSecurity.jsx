...
const SettingsSecurity = () => {
  ...
  <div className={sttngsPrtsCss.settings_parts_content+' '+sttngsPrtsCss.settings_security_block}>
    <div className={sttngsPrtsCss.settings_block}>
      <div className={sttngsPrtsCss.settings_block_h}>Безопасность аккаунта <img src={'/imgs/icons/settings_alert.svg'} alt="" /></div>
    ...
    <div className={sttngsPrtsCss.settings_block}>
      <div className={sttngsPrtsCss.settings_block_h}>Электронная почта  <img src={'/imgs/icons/settings_email.svg'} alt="" /><img src={'/imgs/icons/settings_alert.svg'} alt="" /></div>
          <div className={sttngsPrtsCss.settings_row}>
    ...
    <div className={sttngsPrtsCss.settings_block}>
      <div className={sttngsPrtsCss.settings_block_h}>Пароль аккаунта <img src={'/imgs/icons/settings_password.svg'}/></div>
          <div className={sttngsPrtsCss.settings_row}>
