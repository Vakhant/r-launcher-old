...
const MonitoringServerBlock = ({infoCall, imgSrc, serverName, serverColloredComment, star, nameColor, chosen}) => {
  return (
    ...
    <div style={{"background": `linear-gradient(90deg, ${nameColor}30, transparent)`}} className={css.server_block_bg}></div>
      <div className={css.server_block_img}><img src={process.env.PUBLIC_URL+imgSrc} alt="" /></div>
      ...
      <div className={css.server_vip_wrap}>
        <img className={css.server_vip} src={star? process.env.PUBLIC_URL+"/imgs/icons/main_page/star.svg": process.env.PUBLIC_URL+'/imgs/icons/monitoring/star.svg'} alt="" />
      ...
      {chosen?<button className={css.button_play}>
        <img width={13} height={15} className={css.button_play_icon} src={process.env.PUBLIC_URL+'/imgs/icons/play_video.svg'} alt="" />
      ...
      <Button customClasses={css.monitoring_btn} buttonStyle={'greyBtn'} style={{}} content={<>
        ...
        <img width={13} height={13} className={css.btns_imgs} 
          src={chosen? process.env.PUBLIC_URL+'/imgs/icons/main_page/select_check-mark.svg': process.env.PUBLIC_URL+'/imgs/icons/popup_main_close.svg'} alt=""/>
      </>}/>
    </div>
  )
}
